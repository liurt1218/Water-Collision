...
def main():
    ...
    os.makedirs("frames/bunnies", exist_ok=True)
    ...
    for frame in range(n_frames):
        ...
        fname = f"frames/bunnies/frame_{frame:04d}.png"
        window.save_image(fname)
        print("saved", fname)
    os.system(
        "ffmpeg -framerate 30 -i frames/bunnies/frame_%04d.png -c:v libx264 -pix_fmt yuv420p bunnies.mp4 -y"
    )
